...
<html>
    ...
    <body>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
                <a class="navbar-brand" href="index.html">Menu Convocatoria</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="secciones/inscripcion.html">Inscripcion</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="secciones/registrarUsuario.html">Regístrese</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="login.html">Iniciar Sesion</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="listaConvocatoriasX.jsp">Listado Convocatorias</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="m-0 text-center text-black">
            <form id="frmRegistrar" name="frmRegistrar" action="../resp/guardConv.jsp" method="post" class="m-0 text-center text-black" >

                <label for="codigo">CÃ³digo Convocatoria</label><br>                
                ...
                <label for="desc">Descripcion de la Convocatoria</label><br>                
                ...
                <label for="fechafinal">Digite la fecha final</label>   <br>             
